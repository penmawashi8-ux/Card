...
import type { GameSettings } from '@/types/buta';
import { RoomLobby } from '@/components/buta/RoomLobby';
import { isFirebaseEnabled, createRoom, joinRoom } from '@/lib/buta/firebase';
...
export default function OnlinePage() {
  ...
  async function handleCreateRoom(playerName: string, settings: GameSettings) {
    ...
    try {
      ...
      router.push(`/buta/online/${room.id}`);
    } catch (err) {
